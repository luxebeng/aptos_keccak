...
/// n_r = 12 + 2L = 12 + 2*6 = 24
/// rate = 200 - bits / 4;
module aptos_keccak::hasher {
    use aptos_keccak::keccakstate::{Self, KeccakState};
...
module aptos_keccak::keccakstate {
    use std::error;
    use std::vector;

    use aptos_keccak::keccakbuffer::{Self, Buffer};
...
module aptos_keccak::keccakbuffer {
    use std::bcs;
    use std::math64::min;
    use std::vector;
    use std::error;
